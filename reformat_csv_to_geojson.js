...
fs.readFile('data/airport.json', 'utf8', function (err, airportdata) {
    ...
    fsairlines.readFile('data/arrival_data.csv', 'utf8', function(err, flightlinedata){
        ...
        fswirting.writeFile('data/arrivaldata.json', JSON.stringify(allflows, null, 4), function(err) {
            if(err) {
                console.log(err);
            } else {
