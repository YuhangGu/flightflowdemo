    ...
    init: function () {
        ...
        function createFlows(callback) {
            ...
            var map = new mapboxgl.Map({
                container: 'flowmapVR', // container id
            ...
            map.on("load", function () {
                ...
                var geometry = new THREE.PlaneGeometry(roomWidth, roomHeight, 2);
                ...
                d3.json("../data/icelandlocal.json", function (data) {
                    ...
                    var width = roomWidth, height = roomHeight;
